...
if(isset($_POST['order'])){
   ...
   if($user_id == ''){
      ...
      $address = $_POST['flat'].',  House no.: '.$_POST['pin_code'];
...
<head>
   ...
   <title>Gharelu Flavors - Home</title>
...
<header class="header">
   ...
   <section class="flex">
      ...
      <a href="#home" class="logo"><span>Gharelu</span> Flavors</a>
...
<div class="my-orders">
   ...
   <section>
      ...
      <div class="box">
         ...
         <p> Mobile : <span><?= $fetch_orders['number']; ?></span> </p>
   ...
   <section class="home" id="home">
      ...
      <div class="slide-container">
         ...
         <div class="slide active">
            <div class="image">
               <img src="images/G9.jfif" alt="" style="border-radius: 20%">
            </div>
            <div class="content">
               <h3>Yomari</h3>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/G3.jfif" alt="" style="border-radius: 20%">
            </div>
            <div class="content">
               <h3>Spicy Choila</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/G4.jfif" alt="" style="border-radius: 20%">
            </div>
            <div class="content">
               <h3>Bara</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/G5.jfif" alt="" style="border-radius: 20%">
            </div>
            <div class="content">
               <h3>Khaja Set</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
         ...
         <div class="slide">
            <div class="image">
               <img src="images/G6.jfif" alt="" style="border-radius: 20%">
            </div>
            <div class="content">
               <h3>Khana Set</h3>
               <div class="fas fa-angle-left" onclick="prev()"></div>
...
<section class="order" id="order">
   ...
   <?php
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>Address</span>
            <input type="text" name="flat" class="box" required placeholder="e.g. Kalanki" maxlength="50">
         </div>
         <div class="inputBox">
            <span>House No.</span>
            <input type="number" name="pin_code" class="box" required placeholder="e.g. 037" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;">
         </div>
      </div>
